...
class ControllerCommonHeader extends Controller {
	protected function index() {
		...
		$this->data['text_customer_reviews'] = $this->language->get('text_customer_reviews');
		...
		if (!$this->user->isLogged() || !isset($this->request->get['token']) || !isset($this->session->data['token']) || ($this->request->get['token'] != $this->session->data['token'])) {
			...
			$this->data['news_list'] = $this->url->link('catalog/news', 'token=' . $this->session->data['token'], 'SSL');
			$this->data['customer_reviews'] = $this->url->link('catalog/testimonial', 'token=' . $this->session->data['token'], 'SSL');
			

            $this->data['gallery'] = $this->url->link('catalog/gallimage', 'token=' . $this->session->data['token'], 'SSL');

            $this->data['sync'] = $this->url->link('sync/index', 'token=' . $this->session->data['token'], 'SSL');
            $this->data['text_sync'] = 'Синхронизация';

            $this->load->model('sync/sync');
            $this->data['sync_allowed']=$this->model_sync_sync->sync_allowed();
