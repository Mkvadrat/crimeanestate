...
class ControllerCatalogCategory extends Controller { 
	...
	private function getForm() {
		...
		if (isset($this->request->post['quantity_column'])) {
			$this->data['quantity_column'] = $this->request->post['quantity_column'];
		} elseif (!empty($category_info)) {
			$this->data['quantity_column'] = $category_info['quantity_column'];
		} else {
			$this->data['quantity_column'] = '';
		}
		
		$this->data['quantity_column'] = array('0'=>'Одна', '1'=>'Две');
		
		$this->data['quantity_column_info'] = $this->model_catalog_category->getQuantityColumn($this->request->get['category_id']);
