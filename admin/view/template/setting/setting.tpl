      ...
      <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <div id="tab-general">
          <table class="form">
			...
			<tr>
              <td>Информация об агенстве в разделе контакты</td>
              <td colspan="3"><textarea name="inf_agents" id="textarea_agents"><?php echo $inf_agents; ?></textarea>
            </tr>
            <!--Информация об агенстве-->
            <script type="text/javascript">
                CKEDITOR.replace( 'textarea_agents' );
            </script>
            <!--Информация об агенстве-->
          </table>
        </div>
