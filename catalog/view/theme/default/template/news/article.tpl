  ...
  <div style="display: block;">
   ...
   <?php if ($acom != 0) { ?>
    ...
    <div class="article-content">
     ...
     <br />
     <div class="buttons">
      <div class="left_article"><a id="button-comment" class="button"><span class="input_enter"><?php echo $text_send; ?></span></a></div>
     </div>
    </div>
    <?php } ?>
	<div class="buttons">
       <div class="right_article"><a onclick="location='<?php echo $news; ?>'" class="button"><span class="input_enter"><?php echo $button_news; ?></span></a></div>
	</div>
   </div>
   <?php } ?>
  </div>
...
//--></script> 
<script type="text/javascript"><!--
jQuery('#button-comment').bind('click', function() {
	jQuery.ajax({
		type: 'POST',
		...
		beforeSend: function() {
			...
			jQuery('#button-comment').attr('disabled', true);
		...
		complete: function() {
			jQuery('#button-comment').attr('disabled', false);
