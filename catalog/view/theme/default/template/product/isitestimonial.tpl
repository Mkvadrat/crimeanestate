...
<div class="content">
    <div class="conteiner article-container testimonials">
  <div class="top">
    <div class="left"></div>
    <div class="right"></div>
    <div class="center">
  ...
  <div class="middle">
	...
	<div class="content">
      ...
      <div class="buttons">
        <table width=100%>
          <tr>
            <td width=50%><a style="float:none;cursor:pointer" onclick="$('#testimonial').submit();" class="button"><span><?php echo $button_send; ?></span></a></td>
